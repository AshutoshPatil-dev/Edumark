    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 max-w-md w-full text-center space-y-4">
          ...
          <p className="text-slate-500">{profileError}</p>
          <button
            onClick={handleLogout}
            className="mt-6 w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 px-4 rounded-xl transition-all"
          >
            Sign Out
          </button>
        </div>
